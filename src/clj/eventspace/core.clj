...
(defmethod event-msg-handler :space/list
  ...
  (?reply-fn [{:title "Cricket" :id 18347125 :summary "Some stuff about Cricket"
               :space/feed [{:id 12315 :type :message :author "Sam" :date "20/5/2015 19:12:21" :content "Nam tempor porta turpis, quis vehicula nibh viverra vitae. Aliquam erat volutpat. Nunc ullamcorper tincidunt feugiat. Curabitur sed risus id tortor finibus malesuada. Fusce luctus magna sit amet diam ullamcorper venenatis."
                       :children []}
